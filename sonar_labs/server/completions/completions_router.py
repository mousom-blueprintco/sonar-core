...
from sonar_labs.open_ai.openai_models import (
    OpenAICompletion,
    OpenAIMessage,
)
from sonar_labs.server.chat.chat_router import ChatBody, chat_completion
...
def prompt_completion(
    ...
    "model":"sonar-labs","choices":[{"index":0,"delta":{"content":"Hello"},
    "finish_reason":null}]}
    ```
    """
