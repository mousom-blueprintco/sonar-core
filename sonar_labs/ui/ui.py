...
from sonar_labs.server.chat.chat_service import ChatService, CompletionGen
from sonar_labs.server.chunks.chunks_service import Chunk, ChunksService
from sonar_labs.server.ingest.ingest_service import IngestService
from sonar_labs.settings.settings import settings
from sonar_labs.ui.images import logo_svg
...
if __name__ == "__main__":
    ui = global_injector.get(SonarLabsUI)
