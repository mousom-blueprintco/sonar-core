...
from sonar_labs.components.llm.prompt_helper import get_prompt_style
from sonar_labs.paths import models_cache_path, models_path
...
class LLMComponent:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        match settings.llm.mode:
            ...
            case "sagemaker":
                try:
                    from sonar_labs.components.llm.custom.sagemaker import SagemakerLLM
                except ImportError as e:
                    raise ImportError(
