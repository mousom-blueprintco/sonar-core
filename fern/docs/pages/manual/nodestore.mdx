## NodeStores
SonarLabs supports **Simple** and [Postgres](https://www.postgresql.org/) providers. Simple being the default.
...
```
postgres=# \dt sonar_labs.*
                  List of relations
   Schema    |      Name       | Type  |    Owner     
-------------+-----------------+-------+--------------
 sonar_labs | data_docstore   | table | postgres
 sonar_labs | data_indexstore | table | postgres
