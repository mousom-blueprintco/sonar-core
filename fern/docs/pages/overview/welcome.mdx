SonarLabs provides an **API** containing all the building blocks required to
...
That means that, if you can use OpenAI API in one of your tools, you can use your own SonarLabs API instead,
